...
> **Production status:** The exact 170.000-second candidate is rendered at
> `/private/tmp/commonmesh-demo-final-331fe821.mp4` with SHA-256
...
> Ultra visual checks pass. Explicit upload approval, YouTube upload, and
> public playback verification remain open; there is no public video URL yet.

The English narration and
[`DEMO_VIDEO_CAPTIONS.srt`](DEMO_VIDEO_CAPTIONS.srt) are picture-locked to this
2:50 edit. The caption file SHA-256 is
`ddde148545c7b96c1b2878eb2a84129e5a83da13f2fea411bbbdb8ca831dd506`.
...
- [x] Captions are picture-locked to the final narration; SHA-256
  `ddde148545c7b96c1b2878eb2a84129e5a83da13f2fea411bbbdb8ca831dd506`.
...
- [ ] Obtain explicit approval for the exact YouTube title, description,
  audience, language, thumbnail, captions, visibility, and MP4 hash.
- [ ] Upload only after approval, wait for HD processing, and verify public
  playback and captions in a signed-out session.
- [ ] Add the exact verified URL to README, both submission documents, this
  production record, the video manifest, judging checklist, WebMCP evaluation
  matrix, and the Devpost project; then read it back from Devpost.
