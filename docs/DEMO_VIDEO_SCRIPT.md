...
- [x] Add the exact verified URL to README, both submission documents, this
  ...
  evaluation matrix.
- [x] Add the URL to the live Devpost project and read it back from Devpost.
...
- [x] Obtain a separate explicit **yes, submit**, submit the WebMCP Challenge
  entry, and verify the live Devpost submission timestamp.
